...
document.addEventListener("DOMContentLoaded", () => {
    ...
    btn.addEventListener("click", async (e) => {
      ...
      try {
        ...
        if (error) {
          ...
          btn.disabled = false;
          btn.innerHTML = GOOGLE_ICON_HTML;
        } else {
  ...
  // GitHub OAuth — bind ALL buttons with class .btn-github-login
    ...
    btn.addEventListener("click", async (e) => {
      ...
      try {
        ...
        if (error) {
          ...
          btn.disabled = false;
          btn.innerHTML = GITHUB_ICON_HTML;
        } else {
